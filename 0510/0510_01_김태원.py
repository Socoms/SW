...
fruits.append('수박')
print("과일 목록(수박추가) : " , fruits)

# 망고 추가
fruits.append('망고')
print("과일 목록(망고추가) : " , fruits)
...
print("과일 리스트 중 1~3번 과일은?", fruits[:3])   # 처음부터 2번지 까지

print("과일 리스트 중 3번부터 마지막까지 과일은?", fruits[2:])  # 2번지 ~ 마지막까지
...
# 사과 삭제 => remove()메소드 => 삭제할 항목을 반드시 지정
fruits.remove('사과')   # 처음 만나는 사과만 삭제
print("과일 목록(사과삭제) : ",fruits)

# pop()메소드 => 마지막 항목 삭제
fruits.pop()
print("과일 목록(삭제) : ", fruits)

# del() 키워드
del fruits[0]   # 번지 지정하여 삭제
print("과일 목록(0번지 삭제) : ", fruits)