"""
    ...
    [문제]
        사용자로부터 시작 값과 끝 값을 입력 받아 두 수 사이의 
        전체 합계와 짝수의 합계, 홀수의 합계를 출력하시오
    ...
    [문제분석]
        ...
        입력 받은 두 수 사의를 반복하면서 합게를 계산한다.
        
        num1 < num2 => num1 부터 num2까지 1씩 중가하면서...
        num1 > num2 ???
                => 1) num1부터 num2까지 1씩 감소하면서...
                => 2) num2부터 num1까지 1씩 증가하면서...
                => 3) 두 변수의 값을 교환한다.
                => 4) 사용자에게 첫번째 값을 작은 값, 두번째 값은 큰 값으로 
                      입력하도록 가이드 준다.
...
print(f"{num1}부터 {num2}까지 전체합 : {total_sum}")
print(f"{num1}부터 {num2}까지 짝수합 : {even_sum}")
print(f"{num1}부터 {num2}까지 홀수합 : {odd_sum}")
